    ...
    for url in url:
        try:
            ...
            if url.startswith('http://') or url.startswith('https://'):
                urllib.request.urlretrieve(url, path, reporthook=lambda blocknum, bs, size: print(f"{blocknum*bs/1024/1024:0.3f}MB/{size/1024/1024:0.3f}MB" if blocknum%256==0 else None, end="\r"))
